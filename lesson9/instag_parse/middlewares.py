...
class InstagParseSpiderMiddleware:
...
class InstagParseDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
# Блок кода вставлен с официального сайта scrapy (там был пример кода. работоспособность не проверялась)
